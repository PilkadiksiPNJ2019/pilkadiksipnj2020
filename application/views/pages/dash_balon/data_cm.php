...
<section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Campaign Manager</li>
    </ol><br>
...
<section class="content">
    ...
    <div class="box box-info">
        ...
        <!-- /.box-header -->
        <!-- form start -->
		<?php echo form_open_multipart('data_cm/update');?>
			<input type="hidden" name="cek_data" value="<?php echo count($cm);?>">
            <input type="hidden" name="nim_balon" value="<?php echo $nim_balon;?>">
